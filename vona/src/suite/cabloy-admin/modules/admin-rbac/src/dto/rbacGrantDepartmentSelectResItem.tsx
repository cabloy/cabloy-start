...
export interface IDtoOptionsRbacGrantDepartmentSelectResItem extends IDecoratorDtoOptions {}

@Dto<IDtoOptionsRbacGrantDepartmentSelectResItem>({
  blocks: [
...
export class DtoRbacGrantDepartmentSelectResItem extends $Dto.get(() => ModelRbacGrantDepartment) {
  @Api.field(
