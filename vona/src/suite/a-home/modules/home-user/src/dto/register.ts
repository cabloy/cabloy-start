...
export class DtoRegister {
  @Api.field(
    ...
    v.min(3),
    v.trim(),
    ZovaRender.field('start-input:formFieldInput', { type: 'text' }),
  )
  username: string;
  ...
  @Api.field(
    ...
    v.email(),
    v.trim(),
    ZovaRender.field('start-input:formFieldInput', { type: 'email' }),
  )
  email: string;
  ...
  @Api.field(
    ...
    v.min(6),
    v.max(20),
    ZovaRender.field('start-input:formFieldInput', { type: 'password' }),
  )
  password: string;
