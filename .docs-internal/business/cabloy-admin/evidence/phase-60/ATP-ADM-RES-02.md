...
Pass. Scoped Admin Department OpenAPI generation from live Swagger, the paired Start Admin SSR/REST build, `deps:vona` synchronization, and the full Zova/Vona TypeScript check passed. The focused backend membership suite reported 5 passed, 0 failed, and 1 PostgreSQL-only skipped test. The clean focused browser scenario reported 1 passed in 9.8 seconds; the clean tagged browser suite reported 3 tests passed in 12.8 seconds, including this scenario.
...
- [Current redacted Start Admin DELETE-body browser record](./artifacts/2026-08-16-2866374-start-admin-delete-body-browser.md)
